...
export default function Adsets({auth, campaignsData}) {
    console.log(Object.values(campaignsData['dados']))
    return(
        <Campanhas auth={auth}>
                ...
                <div className='bg-card mt-4 border-t border-border overflow-y-scroll no-scrollbar'>
                        <Table className="text-card-foreground border-collapse" overflow={"no-scrollbar"}>
                            ...
                            <TableBody className="shadow-md  ">
                                {Object.values(campaignsData['dados']).map((campaign) => (
                                    <TableRow key={campaign.campaign_name}>
                                        <TableCell className="text-center text-xs border-r">{campaign.campaign_name}</TableCell>
